                    ...
                    <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="kategori_ad" id="first-name" required="required" class="form-control col-md-7 col-xs-12" placeholder="Kategori adını giriniz">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="kategori_sira" id="first-name" required="required" class="form-control col-md-7 col-xs-12" placeholder="Kategori sıra giriniz" >
                        </div>
                      </div>
                       <div class="form-group">

                    ...
                    <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="ayar_analystic" id="first-name" class="form-control col-md-7 col-xs-12" value="<?php echo $ayarcek['ayar_analystic'] ?>">
                        </div>
                      </div>
                        <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="ayar_maps" id="first-name" class="form-control col-md-7 col-xs-12" value="<?php echo $ayarcek['ayar_maps'] ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="ayar_zopim" id="first-name" class="form-control col-md-7 col-xs-12" value="<?php echo $ayarcek['ayar_zopim'] ?>">
                        </div>
                      </div>

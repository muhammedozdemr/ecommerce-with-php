                     ...
                     while($kategoricek=$kategorisor->fetch(PDO::FETCH_ASSOC)) {
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="urun_ad" id="first-name" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $uruncek['urun_ad'] ?>">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="urun_fiyat" id="first-name" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $uruncek['urun_fiyat'] ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="urun_video" id="first-name"  class="form-control col-md-7 col-xs-12" value="<?php echo $uruncek['urun_video'] ?>" >
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="urun_keyword" id="first-name" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $uruncek['urun_keyword'] ?>" >
                        </div>
                      </div>
                        <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="urun_stok" id="first-name" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $uruncek['urun_stok'] ?>" >
                        </div>
                      </div>
                       <div class="form-group">
